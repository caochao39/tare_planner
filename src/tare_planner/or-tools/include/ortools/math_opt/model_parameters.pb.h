...
class ObjectiveParametersProto final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.math_opt.ObjectiveParametersProto) */ {
 public:
  ...
  inline ObjectiveParametersProto(const ObjectiveParametersProto& from)
      : ObjectiveParametersProto(nullptr, from) {}
...
inline ::operations_research::math_opt::ObjectiveParametersProto* ModelSolveParametersProto::_internal_mutable_primary_objective_parameters() {
  ...
  if (_impl_.primary_objective_parameters_ == nullptr) {
    auto* p = CreateMaybeMessage<::operations_research::math_opt::ObjectiveParametersProto>(GetArena());
...
inline void ModelSolveParametersProto::set_allocated_primary_objective_parameters(::operations_research::math_opt::ObjectiveParametersProto* value) {
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::operations_research::math_opt::ObjectiveParametersProto*>(_impl_.primary_objective_parameters_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::operations_research::math_opt::ObjectiveParametersProto*>(value)->GetArena();
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000020u;
...
inline const ::google::protobuf::RepeatedField<::int64_t>& ModelSolveParametersProto::_internal_lazy_linear_constraint_ids()
    const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
